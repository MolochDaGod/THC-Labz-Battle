...
const ProfessionalHeaderBanner: React.FC<ProfessionalHeaderBannerProps> = ({
  ...
  return (
    <div 
      ref={bannerRef}
      className="absolute top-0 left-0 w-full overflow-hidden transition-all duration-[2000ms] ease-in-out"
      style={{ 
    ...
    >
      ...
      <div 
        className={`absolute inset-0 bg-gradient-to-b ${currentPhase.gradient} transition-all duration-[2000ms] ease-in-out opacity-70`}
      />

      {/* Sun */}
      <div 
        ref={sunRef}
        className={`absolute top-8 w-16 h-16 bg-gradient-radial from-yellow-300 to-orange-400 rounded-full shadow-lg transition-all duration-[2000ms] ease-in-out ${currentPhase.sunPosition}`}
        style={{ 
          opacity: currentPhase.sunOpacity,
      ...
      <div 
        ref={moonRef}
        className={`absolute top-12 w-12 h-12 bg-gradient-radial from-gray-200 to-gray-400 rounded-full shadow-md transition-all duration-[2000ms] ease-in-out ${currentPhase.moonPosition}`}
        style={{ 
          opacity: currentPhase.moonOpacity,
