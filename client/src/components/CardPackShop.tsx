...
const PACK_TYPES = [
  ...
  },
  {
    ...
    color: '#ffeaa0',
    bgImage: '/card-art/pack-sour-diesel.jpg',
    tagline: '"Street-grown Nope units, epic guaranteed"',
    flavorNotes: ['🌱 Bad Seed Line', '💀 Epic or Better', '🟣 Background Bonus 1%'],
    effectDesc: 'Draws only from the BadBudz set listed on /library. 1% of pulls get a Growerz background bonus that glitches the added cost.',
    odds: [
      { r: 'Uncommon',  p: '10%', c: '#a855f7' },
      { r: 'Rare',      p: '25%', c: '#22c55e' },
      { r: 'Epic',      p: '45%', c: '#fbbf24' },
      { r: 'Legendary', p: '15%', c: '#ff6b00' },
      { r: 'Mythic',    p: '5%',  c: '#22d3ee' },
    ],
    previewCards: [
      '/card-art/beast-dank-hound.png',
      '/card-art/raclavin-the-dank-king.png',
      '/card-art/aurora-pheno-witch.png',
    ],
  },
  {
    id: 'grudawars-pack' as const,
    name: 'GrudaWars Pack',
    strain: 'GRUDA',
    tag: 'GRUDAWARS',
    gbuxCost: 80,
    ...
    color: '#22d3ee',
    bgImage: '/card-art/pack-white-widow.jpg',
    tagline: '"Canonical Gruda line, guaranteed rare"',
    flavorNotes: ['⚔️ Warden / Blade / King', '🌀 Mythic possible', '🟣 Background Bonus 1%'],
    effectDesc: 'Draws only from the GrudaWars set listed on /library. Same Clash cost/ATK/HP as the matching units. 1% background glitch.',
    odds: [
      { r: 'Uncommon',  p: '20%', c: '#a855f7' },
      { r: 'Rare',      p: '40%', c: '#22c55e' },
      { r: 'Epic',      p: '25%', c: '#fbbf24' },
      { r: 'Legendary', p: '12%', c: '#ff6b00' },
      { r: 'Mythic',    p: '3%',  c: '#22d3ee' },
    ],
    previewCards: [
      '/card-art/resin-colossus.png',
      '/card-art/raclavin-the-dank-king.png',
      '/card-art/zephyrix.png',
    ],
  },
] as const;
