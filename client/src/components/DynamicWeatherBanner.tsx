...
export const DynamicWeatherBanner: React.FC<WeatherBannerProps> = ({ 
  ...
  return (
    <div className="absolute inset-0 w-full h-32 overflow-hidden transition-all duration-[2s] ease-in-out" style={{ zIndex: -10, pointerEvents: 'none' }}>
      {/* Sky Gradient Background */}
      <div 
        className={`absolute inset-0 bg-gradient-to-b ${phase.gradient} transition-all duration-[2s] ease-in-out`}
      />
      ...
      {/* Sun */}
      <div 
        className={`absolute top-8 w-12 h-12 bg-yellow-300 rounded-full shadow-lg transition-all duration-[2s] ease-in-out ${phase.sunPosition}`}
      ...
      {/* Moon */}
      <div 
        className={`absolute top-12 w-8 h-8 bg-gray-200 rounded-full shadow-md transition-all duration-[2s] ease-in-out ${phase.moonPosition}`}
